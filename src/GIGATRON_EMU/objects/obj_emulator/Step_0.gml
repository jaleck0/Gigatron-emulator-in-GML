...
if (t < 0) 
{
	buffer_poke(current_state, REG.PC_0, buffer_u16, 0)
}

var new_state = cpu_cycle(current_state);
...
if (vgaX++ < 172 && vgaX > 12)
{
	...
	buffer_poke(FRAME, (vgaY*160) + (vgaX-12), buffer_u8, buffer_peek(current_state, REG.OUTPUT, buffer_u8) & 63)
